...
class LinkedList {
  ...
  */
  ...
  /*
    ...
    Space Complexity: O(1)
  */
  // Note that we need to keep a track of current and previous because we have to insert something between
  // 2 nodes and we need something to link this new node to previous node and the node after that.
  insertAt(index, data) {
